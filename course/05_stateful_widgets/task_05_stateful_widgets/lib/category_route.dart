...
// TOD O: Make CategoryRoute a StatefulWidget
class CategoryRoute extends StatefulWidget {
  const CategoryRoute();

  // T ODO: Create State object for the CategoryRoute
...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  Widget build(BuildContext context) {
    // TOD O: Instead of re-creating a list of Categories in every build(),
